...
public class RandomIterTest {
    ...
    public static void imagePreparation() {
        ...
        iterByteIMGFloat = javax.media.jai.iterator.RandomIterFactory.create(testImageByteIMGFloat, null);

        iterShortIMGFloat = javax.media.jai.iterator.RandomIterFactory.create(testImageShortIMGFloat, null);

        iterIntIMGFloat = javax.media.jai.iterator.RandomIterFactory.create(testImageIntIMGFloat, null);

        iterByteIMGDouble = javax.media.jai.iterator.RandomIterFactory.create(testImageByteIMGDouble, null);

        iterShortIMGDouble = javax.media.jai.iterator.RandomIterFactory.create(testImageShortIMGDouble, null);

        iterIntIMGDouble = javax.media.jai.iterator.RandomIterFactory.create(testImageIntIMGDouble, null);
