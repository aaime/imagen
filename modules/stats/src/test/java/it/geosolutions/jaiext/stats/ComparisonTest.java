...
public class ComparisonTest extends TestBase {
    ...
    public void testStatsDescriptor() {
        ...
        for (int i = 0; i < totalCycles; i++) {
            ...
            if (OLD_DESCRIPTOR) {
                if (STATISTIC == 0) {
                    imageStats = javax.media.jai.operator.MeanDescriptor.create(testImage, roi, xPeriod, yPeriod, null);
                } else if (STATISTIC == 1) {
                    imageStats = javax.media.jai.operator.ExtremaDescriptor.create(
                            testImage, roi, xPeriod, yPeriod, false, 1, null);
                } else if (STATISTIC == 2) {
                    imageStats = javax.media.jai.operator.HistogramDescriptor.create(
